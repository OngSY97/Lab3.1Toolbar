package my.edu.tar.lab31toolbar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(toolbar);//support toolbar
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            if (size < max){
                ...
                Toast.makeText(getApplicationContext(), "This is Maximum Size Already",Toast.LENGTH_SHORT).show();
            }
            ...
            if (size > min){
                ...
                Toast.makeText(getApplicationContext(), "This is Minimum Size Already",Toast.LENGTH_SHORT).show();
            }
